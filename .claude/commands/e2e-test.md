...
```bash
cd /Users/mac/Desktop/code-open/wenexus/frontend
pnpm test:e2e
```
...
1. 查看测试报告：
   ...
   ```bash
   cd /Users/mac/Desktop/code-open/wenexus/frontend/packages/e2e
...
2. 查看具体失败日志：
   ...
   ```bash
   # 查看最近的测试输出
   ls -lt /Users/mac/Desktop/code-open/wenexus/frontend/packages/e2e/test-results/ | head -10
   ```
...
1. 获取公网地址：
   ...
   ```bash
   grep -o 'https://[^[:space:]]*\.trycloudflare\.com' /Users/mac/Desktop/code-open/wenexus/scripts/logs/tunnel.log | tail -1
   ```

2. 验证公网可访问：

   ```bash
   PUBLIC_URL=$(grep -o 'https://[^[:space:]]*\.trycloudflare\.com' /Users/mac/Desktop/code-open/wenexus/scripts/logs/tunnel.log | tail -1)
...
```bash
tail -50 /Users/mac/Desktop/code-open/wenexus/scripts/logs/frontend.log
```
