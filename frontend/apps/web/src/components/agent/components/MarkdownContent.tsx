        ...
        <ReactMarkdown
          ...
          components={{
            ...
            blockquote({ children }: { children?: React.ReactNode }) {
              return (
                <blockquote className="text-primary/50 border-border my-4 border-l-4 pl-4 italic">
                  {children}
                </blockquote>
              );
            },
            ...
            table({ children }: { children?: React.ReactNode }) {
              return (
                <div className="my-4 overflow-x-auto">
                  <table className="[&_th]:bg-surface [&_td]:border-border [&_th]:border-border w-full border-collapse [&_td]:border [&_td]:p-2 [&_th]:border [&_th]:p-2 [&_th]:text-left [&_th]:font-semibold">
                    {children}
                  </table>
                </div>
              );
