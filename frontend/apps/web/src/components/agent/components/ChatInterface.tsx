  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden">
      ...
      <div className="bg-background flex-shrink-0">
        <div
          className={cn(
            'border-border bg-background mx-4 mb-6 flex flex-shrink-0 flex-col overflow-hidden rounded-xl border',
            'mx-auto w-[calc(100%-32px)] max-w-[1024px] transition-colors duration-200 ease-in-out'
          )}
        >
          {(hasTasks || hasFiles) && (
            <div className="border-border bg-sidebar flex max-h-72 flex-col overflow-y-auto border-b empty:hidden">
              {!metaOpen && (
                <>
                  {(() => {
                          ...
                          {(() => {
                            ...
                            if (activeTask != null) {
                              return [
                                ...
                                <span
                                  key="content"
                                  className="text-muted-foreground min-w-0 gap-2 truncate text-sm"
                                >
                                  {activeTask.content}
                                </span>,
                              ];
          ...
          <form onSubmit={handleSubmit} className="flex flex-col">
            <textarea
              ...
              className="font-inherit text-primary placeholder:text-tertiary field-sizing-content flex-1 resize-none border-0 bg-transparent px-[18px] pt-[14px] pb-[13px] text-sm leading-7 outline-none"
              rows={1}
            />
