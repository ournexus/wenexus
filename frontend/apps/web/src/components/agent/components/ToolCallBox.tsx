        ...
        >
          <div className="flex w-full items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              {statusIcon}
              <span className="text-foreground text-[15px] font-medium tracking-[-0.6px]">
                {name}
              </span>
            </div>
            {hasContent &&
              ...
              <>
                      ...
                      {Object.entries(args).map(([key, value]) => (
                        ...
                        >
                          <button
                            ...
                            className="bg-muted/30 hover:bg-muted/50 flex w-full items-center justify-between p-2 text-left text-xs font-medium transition-colors"
                          >
                ...
                {result && (
                  <div className="mt-4">
                    ...
                    <pre className="border-border bg-muted/40 text-foreground m-0 overflow-x-auto rounded-sm border p-2 font-mono text-xs leading-7 break-all whitespace-pre-wrap">
